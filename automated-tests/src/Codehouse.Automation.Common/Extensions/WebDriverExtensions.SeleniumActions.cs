...
public static partial class WebDriverExtensions
{
    ...
    public static void BrowserSleep(this IWebDriver webDriver, TimeSpan time)
    {
        Thread.Sleep(time);
    }
    ...
    {
        webDriver.WaitForAndFindElement(locator, ElementQuery.Clickable).Click();
    }
    ...
    /// <param name="locator">The specified web element on the page</param>
    /// <param name="timeoutOverride">The maximum wait (in seconds) as the timeout override</param>
    public static void Click(this IWebDriver webDriver, By locator, WaitSettings settings)
    {
        webDriver.WaitForAndFindElement(locator, ElementQuery.Clickable, settings).Click();
    }
    ...
    public static void WaitUntilFrameIsAvailableThenSwitchToIt(this IWebDriver webDriver, string frameName, int? timeoutOverride)
    {
        ...
        webDriver.BrowserSleep(Constants.WaitTimeLimit.ThreeSecond);
    }
